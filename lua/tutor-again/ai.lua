...
function M.build_system_prompt(lang)
  ...
  table.insert(lines, "Direct answer: key sequence + one-line explanation (1-2 lines)")
  table.insert(lines, "If example needed: add ONE short before/after block (2-3 lines)")
  table.insert(lines, "Related commands: list 2-3 max, inline like: See also: `ci(`, `ca(`")
